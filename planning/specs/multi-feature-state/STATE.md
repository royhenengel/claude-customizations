...
- [x] Task 1: Create feature STATE.md template
...
- [x] Task 5: Update plan.md - create feature STATE.md, context-aware registry updates
- [x] Task 6: Update build.md - use feature STATE.md for all execution tracking
...
- Feature STATE.md template created (templates/feature-state-template.md)
...
- plan.md: worktree-first redirect on main, creates feature STATE.md via @template reference, registry-only project updates
- build.md: resume detection in Step 4, feature STATE.md for execution tracking, doc-enforcer + PR reviewers added
...
- Feature STATE.md created for this feature with full build context
...
- Feature CLAUDE.md updated with @STATE.md reference
