---
name: n8n
description: Comprehensive n8n workflow automation expertise. Use when building, debugging, or optimizing n8n workflows, including node configuration, expressions, code nodes (JavaScript/Python), validation, and workflow patterns.
---

# n8n Workflow Automation

Complete reference for building n8n workflows.

## Table of Contents

1. [Quick Start](#quick-start)
2. [Reference Modules](#reference-modules)
...
| Scenario | Use This |
|----------|----------|
| "How do I structure this workflow?" | Workflow Patterns |
| "Node isn't working right" | Node Configuration |
| "Expression syntax error" | Expression Syntax |
| "Need custom logic" | Code Nodes (JS or Python) |
| "Validation error I don't understand" | Validation Expert |
| "Using n8n via MCP" | MCP Tools Expert |
